...
class WorleyNoiseTexture : public Texture {
	GDCLASS(WorleyNoiseTexture, Texture);
...
public:
	void set_noise(Ref<WorleyNoise> p_noise);
	Ref<WorleyNoise> get_noise();
